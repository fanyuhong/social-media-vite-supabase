        ...
        <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-4">
                ...
                <input 
                    ...
                    onKeyDown={(e) => {
                        if (e.keyCode === 13) {
                            ...
                            console.log("Enter key pressed for title input!");
                        }
                    }}
            ...
            <div>
                ...
                <textarea 
                    ...
                    if (e.keyCode === 13) {
                            // Perform action when Enter is pressed
                            console.log("Enter key pressed for content input!");
                        }
                    }}
            ...
            <div>
                ...
                <select id="community" onChange={(event) => handleCommunityChange(event)} className="bg-blue-500 ml-3 py-1">
                    <option value="">-- Choose a Community --</option>
                    { communities?.map((community, key) => (
                        <option value={community.id} key={key}>{community.name}</option>
                    ))}
                </select>
            </div>
            <div>
